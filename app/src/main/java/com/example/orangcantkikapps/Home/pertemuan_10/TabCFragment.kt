package com.example.orangcantkikapps.Home.pertemuan_10 // Sesuaikan package-mu
...
class TabCFragment : Fragment() {
    ...
    // Kumpulan data produk (50 items) sesuai dengan modul lab-mu
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 1. Setup adapter dan aksi klik item
        ...
        // 2. Pasang ke RecyclerView dengan mode Grid (2 Kolom berjejer)
